  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Augsburg | Batu's Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Batu's Barbershop in Augsburg für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Batu's Barbershop | Premium Barbershop Augsburg" />
        <meta
        ...
        <meta name="twitter:title" content="Batu's Barbershop | Premium Barbershop Augsburg" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "Batu's Barbershop",
            "image": "https://gentlemanscut.de/images/logo.png",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Wertachstraße 18",
            ...
            "sameAs": [
              "https://www.facebook.com/batusbarbershop",
              "https://www.instagram.com/batusbarbershop"
            ]
          })}
        </script>
      </Helmet>
